...
<div class="container" style="width: 85%;">
    ...
    <div class="form-group row">
        <form:label for="inputName" class="col-sm-2 col-form-label" path="name">Name</form:label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <form:label for="inputInsertion" class="col-sm-2 col-form-label" path="insertion">Insertion</form:label>
        <div class="col-sm-10">
            <form:input type="text" class="form-control" id="inputInsertion" path="insertion">
        </div>
    </div>

    <div class="form-group row">
        <form:label for="inputLastName" class="col-sm-2 col-form-label" path="lastName">Last name</form:label>
        <div class="col-sm-10">
