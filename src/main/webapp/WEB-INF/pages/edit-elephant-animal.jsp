...
<div class="container" style="width: 85%;">
    ...
    <form id="animalForm" action="/overview/edit" method="POST">
        ...
        <div class="form-group row">
            <label for="inputMaxNumberOfEggs" class="col-sm-2 col-form-label">Ear size</label>
            <div class="col-sm-10">
                <input type="text" name="maxNumberOfEggs" class="form-control" id="inputEarSize"
                       value="${animal.getEarSize()}">
            </div>
        </div>
